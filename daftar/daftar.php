...
<div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
  ...
  <div class="col-md-10 p-5 pt-5">
            <h3><i class="fas fa-users m-lg-15"></i>Admin</h3>
            <hr>
            <div class="row text-white">
                <div class="card bg-primary bg-gradient m-lg-3" style="width: 18rem;">
                    <div class="card-body">
                        <img src="rifqi.jpeg" class="card-img-top" alt="welcome.jpeg">
                        <h5 class="card-title">Rifqi Ahmad Fadhilla</h5>
                        <p class="card-text">Damedane Dame yo Dame Nano yooo...♫♫♫</p>
